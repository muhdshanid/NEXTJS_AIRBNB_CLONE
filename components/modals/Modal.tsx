...
export const Modal = ({
  ...
  return (
    <>
      <div
        className="flex  fixed justify-center inset-0 z-50 outline-none
    focus:outline-none bg-neutral-800/70 overflow-y-auto
    items-center overflow-x-hidden"
      >
        <div
          className="relative w-full md:w-4/6 lg:w-3/6 xl:w-2/6 my-6 mx-auto 
       lg:h-auto md:h-auto"
        >
          <div
          ...
          shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none"
            >
              <div className="flex items-center p-4 rounded-t justify-center relative border-b-[1px]">
                <button
                  onClick={handleClose}
                  className="p-1 border-0 left-9 transition absolute hover:opacity-70"
                >
                  <IoMdClose />
                </button>
